...
WATCHER = PROJECT_ROOT / "scripts/eval_wd03_from780k_stratified_watcher.sh"


class EvalWd03From780kWatcherTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_points_at_780k_run_and_800k_cadence(self) -> None:
        ...
        self.assertTrue(run_dir.endswith("eval-exports/v2-1m-hostnet-wd03-from780k-lr3e6"))
        self.assertTrue(
            eval_root.endswith("eval-results/v2-1m-hostnet-wd03-from780k-lr3e6-stratified10pct")
        )
